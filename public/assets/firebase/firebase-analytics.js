!
    function(e, t) {
        ...
        try {
            (function() {
                He = He && He.hasOwnProperty("default") ? He.
                        default:
                    He;
                var n = function(e, t) {
                ...
                var e, t, i, d = (i = Error, n(e = u, t = i), void(e.prototype = null === t ? Object.create(t) : (o.prototype = t.prototype, new o)), u);
                ...
                var c = (f.prototype.create = function(e) {
                    for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                    for (var r = t[0] || {}, i = this.service + "/" + e, o = this.errors[e], a = o ?
                        function(e, r) {
                ...
                var h = /\{\$([^}]+)}/g,
                    v = (g.prototype.setInstantiationMode = function(e) {
                        return this.instantiationMode = e, this
                    }, g.prototype.setMultipleInstances = function(e) {
                        return this.multipleInstances = e, this
                    }, g.prototype.setServiceProps = function(e) {
                ...
                m(I, "_index", ["name", "keyPath", "multiEntry", "unique"]), b(I, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]), E(I, "_index", IDBIndex, ["openCursor", "openKeyCursor"]), m(S, "_cursor", ["direction", "key", "primaryKey", "value"]), b(S, "_cursor", IDBCursor, ["update", "delete"]), ["advance", "continue", "continuePrimaryKey"].forEach(function(n) {
                ...
                }, m(C, "_store", ["name", "keyPath", "indexNames", "autoIncrement"]), b(C, "_store", IDBObjectStore, ["put", "add", "delete", "clear", "get", "getAll", "getKey", "getAllKeys", "count"]), E(C, "_store", IDBObjectStore, ["openCursor", "openKeyCursor"]), _(C, "_store", IDBObjectStore, ["deleteIndex"]), T.prototype.objectStore = function() {
                    return new C(this._tx.objectStore.apply(this._tx, arguments))
                }, m(T, "_tx", ["objectStoreNames", "mode"]), _(T, "_tx", IDBTransaction, ["abort"]), P.prototype.createObjectStore = function() {
                    return new C(this._db.createObjectStore.apply(this._db, arguments))
                }, m(P, "_db", ["name", "version", "objectStoreNames"]), _(P, "_db", IDBDatabase, ["deleteObjectStore", "close"]), N.prototype.transaction = function() {
                    return new T(this._db.transaction.apply(this._db, arguments))
                }, m(N, "_db", ["name", "version", "objectStoreNames"]), _(N, "_db", IDBDatabase, ["close"]), ["openCursor", "openKeyCursor"].forEach(function(i) {
                ...
                var O, A = "0.4.1",
                    ...
                    L = new c("installations", "Installations", F);
                ...
                var re, ie = "firebase-installations-database",
                    oe = 1,
                    ...
                    return se = se ||
                        function(e, t, n) {
                            ...
                            return i && (i.onupgradeneeded = function(e) {
                                n && n(new P(i.result, e.oldVersion, i.transaction))
                            }), r.then(function(e) {
                                return new N(e)
                            })
                        }(ie, oe, function(e) {
                        ...
                        return p(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return t = Y(a), [4, ue()];
                                case 1:
                                    return n = e.sent(), r = n.transaction(ae, "readwrite"), [4, (i = r.objectStore(ae)).get(t)];
                                case 2:
                    ...
                    return l(this, void 0, void 0, function() {
                        ...
                        return p(this, function(e) {
                            switch (e.label) {
                                            ...
                                            n = function(e, t) {
                                                {
                                                    if (0 !== t.registrationStatus) return 1 === t.registrationStatus ? {
                                                        installationEntry : t, registrationPromise: function(o) {
                                                            return l(this, void 0, void 0, function() {
                                                                var t, n, r, i;
                                                                return p(this, function(e) {
                                                                    switch (e.label) {
                                                                        ...
                                                                        case 1:
                                                                            t = e.sent(), e.label = 2;
                                                                        case 2:
                                                                            return 1 !== t.registrationStatus ? [3, 5] : [4, H(100)];
                                                                        case 3:
                                                                            return e.sent(), [4, de(o)];
                                                                        case 4:
                                                                            return t = e.sent(), [3, 2];
                                                                        case 5:
                                                                            return 0 !== t.registrationStatus ? [3, 7] : [4, pe(o)];
                                                                        case 6:
                                                            ...
                                                            return l(this, void 0, void 0, function() {
                                                                ...
                                                                return p(this, function(e) {
                                                                    switch (e.label) {
                                                                                                ...
                                                                                                return a = e.sent(), [2,
                                                                                                    {
                                                                                                        ...
                                                                                                        authToken: G(a.authToken)
                                                                                                    }];
                                                                                            case 3:
                                                                                                return [4, B("Create Installation", o)];
                                                                                            case 4:
                                                                                                throw e.sent()
                                                                                        }
                                                                                    })
                                                                        ...
                                                                        case 1:
                                                                            return t = e.sent(), [2, ce(r, t)];
                                                                        case 2:
                                                                            return V(n = e.sent()) && 409 === n.serverCode ? [4, fe(r)] : [3, 4];
                                                                        case 3:
                                                                            return e.sent(), [3, 6];
                                                                        case 4:
                                                                            return [4, ce(r, {
                                ...
                                case 1:
                                    return (t = e.sent()).fid !== W ? [3, 3] : (n = {}, [4, r]);
                                case 2:
                            ...
                            switch (e.label) {
                                case 0:
                                    return t = function(e, t) {
                                        var n = t.fid;
                                        return R(e) + "/" + n + "/authTokens:generate"
                                    }(c, u), n = K(c, u), (r = f.getImmediate({
                                        optional: !0
                                ...
                                case 2:
                                    return s = e.sent(), [2, G(s)];
                                case 3:
                                    return [4, B("Generate Auth Token", a)];
                                case 4:
                                    throw e.sent()
                            }
                        })
                ...
                function ge(i, o) {
                    return void 0 === o && (o = !1), l(this, void 0, void 0, function() {
                        ...
                        return p(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return [4, le(i.appConfig, function(e) {
                                        if (!we(e)) throw L.create("not-registered");
                                        var t = e.authToken;
                                        if (!o &&
                                            function(e) {
                                        ...
                                        if (1 === t.requestStatus) return r = function(r, i) {
                                            return l(this, void 0, void 0, function() {
                                                ...
                                                return p(this, function(e) {
                                                    switch (e.label) {
                                                        case 0:
                                                            return [4, ye(r.appConfig)];
                                                        case 1:
                                                            t = e.sent(), e.label = 2;
                                                        case 2:
                                                            return 1 !== t.authToken.requestStatus ? [3, 5] : [4, H(100)];
                                                        case 3:
                                                            return e.sent(), [4, ye(r.appConfig)];
                                                        case 4:
                                                            return t = e.sent(), [3, 2];
                                                        case 5:
                                                            return 0 === (n = t.authToken).requestStatus ? [2, ge(r, i)] : [2, n]
                                                    }
                                                })
                                            })
                                        }(i, o), e;
                                                ...
                                                return p(this, function(e) {
                                                    switch (e.label) {
                                                        ...
                                                        case 2:
                                                            return e.sent(), [2, t];
                                                        case 3:
                                                            return !V(n = e.sent()) || 401 !== n.serverCode && 404 !== n.serverCode ? [3, 5] : [4, fe(i.appConfig)];
                                                        case 4:
                                                            return e.sent(), [3, 7];
                                                        case 5:
                                                            return r = a(a({}, o), {
                ...
                function ye(e) {
                    return le(e, function(e) {
                        if (!we(e)) throw L.create("not-registered");
                        return function(e) {
                            return 1 === e.requestStatus && e.requestTime + k < Date.now()
                        }(e.authToken) ? a(a({}, e), {
                            authToken : {
                                requestStatus: 0
                            }
                    ...
                    return l(this, void 0, void 0, function() {
                        ...
                        return p(this, function(e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    return (i = e.sent()).ok ? [3, 3] : [4, B("Delete Installation", i)];
                                case 2:
                                    throw e.sent();
                                case 3:
                                    return [2]
                ...
                }(re = He).INTERNAL.registerComponent(new v("installations", function(e) {
                            ...
                            return function(i) {
                                return l(this, void 0, void 0, function() {
                                    ...
                                    return p(this, function(e) {
                                        switch (e.label) {
                                            case 0:
                                                return [4, pe(i.appConfig)];
                                            case 1:
                                                return t = e.sent(), n = t.installationEntry, (r = t.registrationPromise) ? r.
                                                catch (console.error) : ge(i).
                                                catch (console.error), [2, n.fid]
                                        }
                                    })
                                })
                            }(n)
                            ...
                            return function(r) {
                                return l(this, void 0, void 0, function() {
                                    ...
                                    return p(this, function(e) {
                                        switch (e.label) {
                                            case 0:
                                                return [4, le(t = r.appConfig, function(e) {
                ...
                }, "PUBLIC")), re.registerVersion("@firebase/installations", A);
                var Ie, Se, Ce, Te, Pe, Ne = "measurementId",
                    Oe = "firebase_id",
                    Ae = "origin",
                    ...
                    return window[t] && "function" == typeof window[t] && (r = window[t]), window[t] = function(p, d) {
                        return function(e, t, n) {
                            if (e === Ie.EVENT) {
                                ...
                                if (0 === r.length) for (var c = 0, f = Object.values(d); c < f.length; c++) {
                                    var l = f[c];
                                    r.push(l)
                                }
                                Promise.all(r).then(function() {
                                    return p(Ie.EVENT, t, n || {})
                                }).
                                catch (function(e) {
                ...
                function Be(e) {
                    if (Ge) throw Fe.create("already-initialized");
                    e.dataLayerName && (Ve = e.dataLayerName), e.gtagName && (Re = e.gtagName)
                }
                function Me(e, t) {
                    var r = e.options[Ne];
                    if (!r) throw Fe.create("no-ga-id");
                    if (null != Le[r]) throw Fe.create("already-exists", {
                        id: r
                    });
                    ...
                    if (!Ge) {
                        ...
                        function(e) {
                            ...
                            t.src = ke + "?l=" + e, t.async = !0, document.head.appendChild(t)
                        }(Ve), function(e) {
                            var t = [];
                            ...
                            return p(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, i.getId()];
                                    case 1:
                                        return t = e.sent(), o("js", new Date), o(Ie.CONFIG, r.options[Ne], ((n = {})[Oe] = t, n[Ae] = "firebase", n.update = !0, n)), [2]
                                }
                            })
                        })
                    }(e, t, xe), {
                ...
                var Ke, Ue = "analytics";
                (Ke = He).INTERNAL.registerComponent(new v(Ue, function(e) {
                    return Me(e.getProvider("app").getImmediate(), e.getProvider("installations").getImmediate())
                }, "PUBLIC").setServiceProps({
                    settings: Be,
                    EventName: Ce
                })), Ke.INTERNAL.registerComponent(new v("analytics-internal", function(e) {
                    try {
                        return {
                            logEvent: e.getProvider(Ue).getImmediate().logEvent
                        }
                    } catch (e) {
                ...
                }, "PRIVATE")), Ke.registerVersion("@firebase/analytics", "0.2.12")
            }).apply(this, arguments)
        } catch (e) {
